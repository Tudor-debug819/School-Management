...
export const loadTeacherCourseStudents = createAction('[Teacher] Load Course Students', props<{ courseId: string }>());
export const loadTeacherCourseStudentsSuccess = createAction('[Teacher] Load Course Students', props<{ courseId: string, students: any[] }>());
